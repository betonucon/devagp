...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{url_plug()}}/plugins/iCheck/square/blue.css">
  ...
  <div class="login-box-body" style="background: #e5d6d67d;">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group has-feedback">
            <input type="text" class="form-control" name="email" placeholder="Username" value="{{ old('email') }}" required autocomplete="email" autofocus>
